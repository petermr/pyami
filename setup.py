...
setup(
    ...
    license='Apache2',
    install_requires=["beautifulsoup4","braceexpand","lxml","matplotlib","nltk","pdfminer3","Pillow","psutil","PyPDF2","RAKE","rake_nltk","setuptools","SPARQLWrapper","tkinterhtml","tkinterweb"],
